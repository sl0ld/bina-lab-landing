...
const quickLinks = [
  { to: "/courses", label: "الدورة", icon: BookOpen },
  { to: "/templates", label: "القوالب", icon: Boxes },
    ...
    <div className="min-h-screen bg-[var(--bg-white)] text-[var(--text-dark)]" dir="rtl">
      <header className="border-b border-[var(--primary-color)]/10 bg-white/95 backdrop-blur">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3">
          <Link to="/" aria-label="binaa LAB" className="flex items-center">
      ...
      <main>
        ...
        <section className="mx-auto max-w-6xl px-5 py-8 md:py-9">
          ...
          <div>
            ...
            <div className="grid gap-3">
              {quickLinks.map((link) => {
                ...
                return (
                  <Link key={link.to} to={link.to} className="inline-flex items-center gap-2 text-sm font-bold text-[var(--text-light)] transition hover:text-[var(--primary-color)]">
